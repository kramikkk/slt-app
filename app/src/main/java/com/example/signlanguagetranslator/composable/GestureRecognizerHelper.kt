...
//            gestureList.forEachIndexed { gestureIndex, gesture ->
//                Log.d(
//                    TAG,
//                    "Hand $handIndex, Gesture ${gestureIndex + 1}: Name: ${gesture.categoryName()}, Score: ${gesture.score()}"
//                )
//            }
//        }
    ...
    companion object {
        ...
        private const val MP_RECOGNIZER_TASK = "slt.task"
